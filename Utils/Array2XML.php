...
namespace Tcgunel\AsistbtSms\Utils;
...
class Array2XML
{
     ...
     * @throws DOMException
     */
    public static function convert(array $array, $rootElement = '', $replaceSpacesByUnderScoresInKeyNames = true, $xmlEncoding = 'UTF-8', $xmlVersion = '1.0')
    {
